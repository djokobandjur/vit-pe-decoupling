...
def main():
    ...
    for ext in ['pdf','png','svg']:
        fig.savefig(out/f'fig_v19_cross_architecture_robustness.{ext}',dpi=300 if ext=='png' else None,bbox_inches='tight')
    plt.close(fig)
    ...
    fig.tight_layout()
    for ext in ['pdf','png','svg']:
        fig.savefig(out/f'fig_v19_d031_layer_profiles.{ext}',dpi=300 if ext=='png' else None,bbox_inches='tight')
    plt.close(fig)
