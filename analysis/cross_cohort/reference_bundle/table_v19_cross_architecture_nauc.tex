...
\centering
\small
\caption{Cross-architecture ImageNet-100 normalized AUC over the locked common-support interval $\rho_{\mathrm{rel}}\in[0,0.07924]$. Values are mean $\pm$ sample SD across the same six training seeds. D019 and D020 are excluded from this canonical support.}
